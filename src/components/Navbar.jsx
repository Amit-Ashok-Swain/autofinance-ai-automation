...
export default function Navbar({ activeTab, setActiveTab, onOpenAiModal, onOpenDossier }) {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#050911]/95 backdrop-blur-2xl border-b border-slate-800/80 shadow-2xl w-full">
      {/* Top Telemetry Strip */}
      <div className="hidden lg:flex items-center justify-between px-4 sm:px-8 lg:px-12 py-1 bg-[#02050b] border-b border-slate-900 text-[11px] font-mono text-slate-400 w-full">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-10 h-16 sm:h-18 flex items-center justify-between gap-3">
        {/* Left: Brand Identity */}
        <div className="flex items-center gap-2.5 sm:gap-3 shrink-0">
          ...
          <div>
            ...
            <p className="text-[10px] sm:text-[11px] text-slate-400 font-mono hidden md:block whitespace-nowrap">
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 px-2.5 2xl:px-3.5 py-1.5 rounded-xl text-xs font-semibold whitespace-nowrap transition-all cursor-pointer ${
                  isActive
        ...
        <button
          ...
          className="flex xl:hidden items-center gap-1.5 px-3 py-1.5 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-bold font-mono cursor-pointer shrink-0"
        >
        ...
        {/* Right: Actions Bar (AI Copilot, Dossier, Sound, Mobile Menu) */}
        <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-1.5 px-3 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-700 text-xs font-mono transition-all cursor-pointer h-9 sm:h-10 shrink-0"
          ...
          <button
            ...
            className="p-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-300 border border-slate-800 transition-all cursor-pointer h-9 w-9 sm:h-10 sm:w-10 flex items-center justify-center shrink-0"
          ...
          <button
            ...
            className="xl:hidden p-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-800 transition-all cursor-pointer h-9 w-9 sm:h-10 sm:w-10 flex items-center justify-center shrink-0"
      ...
      {mobileMenuOpen && (
        <div className="xl:hidden border-t border-emerald-500/20 bg-[#050a14] p-4 sm:p-6 space-y-3 shadow-2xl animate-fadeIn w-full overflow-hidden">
